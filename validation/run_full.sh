...
#python3 $DIR/simulation.py --out_prefix=ccc_full_normal --mode=full --nonlin-trf=squared
...
echo "non-nomral y,c,yhat: delta=5, epsilon=10"
python3 $DIR/simulation.py --out_prefix=ccc_partial_non-normal-all4 --delta-yc=5 --epsilon-yc=10 --delta-yhat=5 --epsilon-yhat=10 --mode=full

echo "non-nomral y,c,yhat: delta=5, epsilon=-10"
python3 $DIR/simulation.py --out_prefix=ccc_partial_non-normal-all5 --delta-yc=5 --epsilon-yc=-10 --delta-yhat=5 --epsilon-yhat=-10 --mode=full
